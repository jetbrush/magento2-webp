;(function () {
    ...
    function replaceWebpWithOriginal(root) {
        window.WebpConfig = window.WebpConfig || {};
        const tags = window.WebpConfig.tags || ['img', 'source', 'a', 'link'];
        const attributes = window.WebpConfig.attributes || ['src', 'srcset', 'data-src', 'data-srcset', 'href', 'imgsrcset'];
